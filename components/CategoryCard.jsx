    ...
    <Link key={category.name} href={`/category/${category.slug}`}>
      <div
        className={`relative ml-2 mt-2 flex ${
          height ? height : 'h-32'
        } cursor-pointer flex-col justify-end border-2 border-midnight-500 p-3 pb-2 text-white-500 before:absolute before:right-[2px] before:bottom-[2px] before:-left-[6px] before:-top-[6px] before:-z-10 before:border-2 before:border-midnight-500 before:bg-white-500 after:absolute after:right-2 after:bottom-2 after:-left-[10px] after:-top-[10px] after:-z-20 after:border-2 after:border-midnight-500 after:bg-white-500`}
        style={{
